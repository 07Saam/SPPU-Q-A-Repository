...
<html lang="en">
	<head>
            ...
            <title>OSC 2022 | Winter Exam</title>
...
<body>
	 <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand text-info" href="FOp.html" target="_blank">SPPU Q&A Repository</a>
        ...
        <div class="container mt-5 me-0">
            <h2 class=""> Operating System Concept (Winter 2022)  </h2>
            <br>
            <a href="Data/OSC_2022(winter).pdf" target="_blank">View question paper</a>
            <br>
<%			
			try{
...
<%
		String Que ="select Q_Id,Question from questions where Subject='Operating System Concept'and Year='2022'";
