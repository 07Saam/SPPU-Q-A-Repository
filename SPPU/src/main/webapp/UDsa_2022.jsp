...
<html lang="en">
	<head>
            ...
            <title>DSA 2022 | Winter Exam</title>
...
<body>
	 <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        ...
        <div class="container mt-5 me-0">
            <h2 class=""> Data Structure and Algorithm (Winter 2022)  </h2>
            <br>
            <a href="Data/DSA_2022(winter).pdf" target="_blank">View question paper</a>
            <br>
<%			
			try{
