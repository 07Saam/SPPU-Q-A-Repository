...
<html lang="en">
 <head>
       <meta charset="UTF-8">
		...
		<title>Java 2022 Solutions</title>
...
<body>
        ...
        <div class="row mt-5 container">
        	<div class="col-3"></div>
        	<div class="col-6 w-75 ps-0 pe-5"><p class="fw-bolder bg-dark fs-5 text-light text-center" style="">Java 2022 (Winter) Solutions</p>
<%
try{
	
	Connection con=DriverManager.getConnection ("jdbc:mysql://localhost/qanda","root","");
	Statement stmt=con.createStatement ();;
	String Que ="select Q_Id,Question from questions where Subject='Java Programing'and Year='2022'";
