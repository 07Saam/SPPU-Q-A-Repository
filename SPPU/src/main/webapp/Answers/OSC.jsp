...
<html lang="en">
 <head>
       ...
       <title>OSC 2022 Solutions</title>
 </head>
<body>
		<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="../HView.html">SPPU Q&A Repository</a>
        ...
        <div class="row mt-5 container">
        	<div class="col-3"></div>
        	<div class="col-6 w-75 ps-0 pe-5"><p class="fw-bolder bg-dark fs-5 text-light text-center" style="">OSC 2022 (Winter) Solutions</p>
<%
try{
