...
<html lang="en">
 <head>
       ...
       <title>OOSE 2022 Solutions</title>
 </head>
<body>
        ...
        <div class="row mt-5 container">
        	<div class="col-3"></div>
        	<div class="col-6 w-75 ps-0 pe-5"><p class="fw-bolder bg-dark fs-5 text-light text-center" style="">OOSE 2022 (Winter) Solutions</p>
<%
try{
